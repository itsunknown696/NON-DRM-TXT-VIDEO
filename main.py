...
photologo = 'https://te.legra.ph/file/890915f38747db8fefa64-d4f035fadcc168c0d6.jpg'
photoyt = 'https://te.legra.ph/file/890915f38747db8fefa64-d4f035fadcc168c0d6.jpg'
photocp = 'https://te.legra.ph/file/890915f38747db8fefa64-d4f035fadcc168c0d6.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🕸️ Join", url="https://t.me/itsnomis"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/Nomis_121_bot"),
        ],
    ]
)
# Image URLs for the random image feature
image_urls = [
    "https://te.legra.ph/file/890915f38747db8fefa64-d4f035fadcc168c0d6.jpg",
    "https://te.legra.ph/file/5162e22ce0fa4148a87b7-fa8edd24bd84d81e46.jpg",
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url=f"https://t.me/King_Nomis")]])
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url or ".jpg" in url or ".jpeg" in url or ".png" in url:
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `ＮＯＭＩＳ`', disable_web_page_preview=True, reply_markup=BUTTONSDOC)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `ＮＯＭＩＳ`', disable_web_page_preview=True, reply_markup=BUTTONSCP)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `ＮＯＭＩＳ`', disable_web_page_preview=True, reply_markup=BUTTONSYT)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                ...
                await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `ＮＯＭＩＳ`', disable_web_page_preview=True, reply_markup=BUTTONSMAN)
                count += 1
                time.sleep(3)
                continue
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『ＮＯＭＩＳ』✨⌋</code></pre>")
